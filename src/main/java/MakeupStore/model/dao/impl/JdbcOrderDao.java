...
import MakeupStore.model.entities.order.OrderStatus;
import MakeupStore.model.entities.order.OrdersExtractor;
...
public class JdbcOrderDao implements OrderDao {
     ...
     */
    private static final String ADD_ORDER2ITEM = "INSERT INTO order2item (orderId, makeupId, quantity) " +
            "VALUES (?, ?, ?)";
    /**
        ...
        try {
            ...
            if (generatedKeys.next()) {
                ...
                for (OrderItem orderItem : order.getOrderItems()) {
                    addOrderItem(conn, orderId, orderItem.getMakeupItem().getId(), orderItem.getQuantity());
                }
     ...
     * @param makeupId  id of makeup item to add
     * @param quantity quantity of makeup items to add
     * @throws SQLException exception throws when there were some problems during sql operation
     */
    private void addOrderItem(Connection conn, Long orderId, Long makeupId, int quantity) throws SQLException {
