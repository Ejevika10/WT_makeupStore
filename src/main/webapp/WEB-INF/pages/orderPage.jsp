...
<jsp:useBean id="order" scope="request" type="MakeupStore.model.entities.order.Order"/>
        ...
        <div class="col-8">
            <table class="table table-bordered text-center">
                ...
                <tr class="bg-light">
                    ...
                    <td>
                        <fmt:message key="item_name" />
                    </td>
                    <td>
                        <fmt:message key="item_cathegory" />
                    </td>
                    <td>
                ...
                <c:forEach var="item" items="${order.orderItems}">
                    <tr>
                        <td class="align-middle">
                                ${item.makeupItem.brand}
                        </td>
                        <td class="align-middle">
                                ${item.makeupItem.name}
                        </td>
                        <td class="align-middle">
                                ${item.makeupItem.cathegory}
                        </td>
                        <td class="align-middle">
                                ${item.quantity}
                        </td>
                        <td class="align-middle">
                                ${item.makeupItem.price}
                        </td>
                    </tr>
                </c:forEach>
                <tr>
